...
func _on_StartMusicButton_pressed():
	SoundController.pub_play_music("res://testmusic/song1.ogg", 0)
	SoundController.pub_play_music("res://testmusic/song2.ogg", 1, -100)
...
func _on_CrossfadeButton_pressed():
	...
	SoundController.pub_crossfade_music_channels(0, 1)
